...
- CSS: project-specific static CSS; no required CSS framework
...
- Keep styling readable, responsive, and maintainable; avoid adding a CSS framework requirement unless the project direction changes.
